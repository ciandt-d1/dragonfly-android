...
@Database(entities = arrayOf(ProjectEntity::class, VersionEntity::class, DownloadEntity::class, PendingFeedbackEntitiy::class, PendingFeedbackLabelEntitiy::class), version = 2)
